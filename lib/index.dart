// Export pages
export 'wallet_setup/wallet_setup_widget.dart' show WalletSetupWidget;
export 'choose_wallet_label/choose_wallet_label_widget.dart'
...
export 'swap_step_one/swap_step_one_widget.dart' show SwapStepOneWidget;
export 'confirm_swap/confirm_swap_widget.dart' show ConfirmSwapWidget;
export 'activity_screen/activity_screen_widget.dart' show ActivityScreenWidget;
export 'swap_activity_screen/swap_activity_screen_widget.dart'
...
export 'notification_center_screen/notification_center_screen_widget.dart'
    show NotificationCenterScreenWidget;
export 'send_bitcoin/send_bitcoin_widget.dart' show SendBitcoinWidget;
export 'confirm_trasnaction/confirm_trasnaction_widget.dart'
    show ConfirmTrasnactionWidget;
export 'success_payment/success_payment_widget.dart' show SuccessPaymentWidget;
export 'receive_bitcoin/receive_bitcoin_widget.dart' show ReceiveBitcoinWidget;
export 'test_screen/test_screen_widget.dart' show TestScreenWidget;
export 'user_wallets/user_wallets_widget.dart' show UserWalletsWidget;
export 'wallet_informations/wallet_informations_widget.dart'
    show WalletInformationsWidget;
