                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '6qr1k9hc' /* We always working hard to impr... */,
                              ),
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintText: FFLocalizations.of(context)
                                              .getText(
                                            'schq69ss' /* Enter your email address... */,
                                          ),
                                          hintStyle: FlutterFlowTheme.of(
                                                  context)
                                              .bodyText1
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          FFLocalizations.of(context).getText(
                                        'mvww9xw7' /* Description */,
                                      ),
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .bodyText2,
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'uco6boad' /* Hello, what do you think of ad... */,
                                      ),
